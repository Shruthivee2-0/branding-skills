...
```bash
# Clone the repo
git clone https://github.com/Shruthivee2-0/branding-skills.git
cd branding-skills

# Option 1: Install via Claude.ai
# Download postman-infographics-skill.tar.gz, extract, then install infographics.skill

# Option 2: Use directly as an API system prompt
cat infographics/SKILL.md
# Paste the contents as your Claude API system prompt

# Option 3: Claude Teams workspace
# Paste infographics/SKILL.md contents into Workspace Settings → Instructions
```
...
The `infographics/` folder contains the full skill. The `postman-infographics-skill.tar.gz` is a bundled download of the same content.
...
All examples below are generated by Claude using this skill — no manual design work.

### Flow diagram
Step-by-step workflows with numbered stages, dashed arrow connectors, and one brand colour family per topic.

![Flow diagram example](https://raw.githubusercontent.com/Shruthivee2-0/branding-skills/main/docs/ex_flow.png)

> Prompt: *"Create a flow diagram showing the 5 stages of the API lifecycle"*

---

### Stats + data visualisation
Hero numbers with colour-coded stat cards and horizontal bar charts with brand-coloured bars.

![Stats example](https://raw.githubusercontent.com/Shruthivee2-0/branding-skills/main/docs/ex_stats.png)

> Prompt: *"Visualise our API platform metrics for Q1 — 4.2M requests/day, 98% uptime, and response times by endpoint"*

---

### Tiered / maturity cards
Vertical stacked cards for levels, stages, or maturity models. Each tier gets a distinct brand colour family.

![Tiered cards example](https://raw.githubusercontent.com/Shruthivee2-0/branding-skills/main/docs/ex_tiered.png)

> Prompt: *"Show the Postman API maturity model across 3 levels"*

---

### Status checklist
Readiness trackers with semantic colour coding — Flora Green ✓, Elemental Yellow !, Rusty Red ✗.

![Checklist example](https://raw.githubusercontent.com/Shruthivee2-0/branding-skills/main/docs/ex_checklist.png)

> Prompt: *"Create a release readiness checklist for our API governance review"*

---

### Bar chart
Vertical bar charts with IBM Plex Mono axis labels, brand-coloured bars, and an insight callout.

> Prompt: *"Generate a bar chart showing API test pass rates by test type"*

---

### Comparison table
Feature matrices with IBM Plex Mono column headers, orange row labels, and ✓/!/— status glyphs.

> Prompt: *"Compare Postman workspace features across Personal, Team, and Enterprise plans"*

---

> **Note on screenshots:** Replace the image URLs above with actual screenshots once the repo is live. 
> Generate them by running each prompt in Claude with this skill active, then screenshotting the output.
